...
Tanto los usuarios miembros como los casuales siguen la misma distribución lo cual puede verse tanto en el gráfico como en el resultado del test de chi-cuadrado (p-value \< 0.05). Ésto significa que en ambos casos, aumenta el número de traslados durante los fines de semana. Por otra parte, la diferencia es más notoria en el caso de los usuarios casuales, por lo cuál, se sugiere atraer a los usuarios casuales con promociones para esos días.
